...
%
% Author: Gorkem Aksaray <gaksaray@ku.edu.tr>
%
% You may use pdfLaTeX, XeLaTeX, or any other engine to typeset this document.
% Although this template is compliant with with AOM specifications, it is not an official template.
% Users are advised to refer to AOM guidelines themselves.
% Please submit bugs and revisions to the GitHub repository at https://github.com/gaksaray/AOM-LaTeX-template.
...
\invisiblesection{Introduction} % section title not shown!
...
The most cited papers in AMJ according to their website are \citet{doi:10.5465/amj.2007.24160888}, \citet{doi:10.5465/amj.2007.28166119}, \citet{doi:10.5465/amj.2013.4001}, and \citet{doi:10.5465/amj.2016.4007}.\footnote{This is an example of a footnote. See \url{https://journals.aom.org/journal/amj}.} \blindtext
