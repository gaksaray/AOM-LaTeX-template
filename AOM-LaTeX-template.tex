% LaTeX template for Academy of Management (AOM)
% by Gorkem Aksaray <gaksaray@ku.edu.tr>
%
...
% Please submit bugs and updates to the GitHub repository at
...
%\setstretch{2} % for Word-like double spacing
...
\postdate{
    ...
    \insertsubid
    \centerline{\textbf{\mytitle}}
    \insertabstract\clearpage
    \centerline{\textbf{\mytitle}}\vspace*{-0.5\baselineskip}
}
...
\def\mytitle{\titlecap{
    A sample \textsf{AOM} draft manuscript%
}}
\title{\mytitle\thanks{
...
The most cited papers in AMJ according to their website are \citet{doi:10.5465/amj.2007.24160888}, \citet{doi:10.5465/amj.2007.28166119}, \citet{doi:10.5465/amj.2013.4001}, and \citet{doi:10.5465/amj.2016.4007}.\footnote{See \url{https://journals.aom.org/journal/amj}.} \blindtext
...
I also wrapped these in a new environment, \verb*|add[l]figure|, which takes four arguments: (1) width, (2) image file name, (3) caption (with optional label), and (4) figure note.
...
Obs         &       39   &       38   &       47   &       39   &       38.00   &       47   &       39   &       38   &       47   \\ \bottomrule
    \end{tabular*}
    \tablenote{\blindtext}
